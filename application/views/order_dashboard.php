...
<html lang="en">
  ...
  <body>
   <div class="container">
    ...
    <!-- search and pull down area -->
    <!-- <div class="container"> -->
		<div class="row">
		  	<div class="col-md-4">
		  		<div class="input-group">		
				  <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span>
	          		<!-- <span class="glyphicon-class">glyphicon glyphicon-zoom-in</span> --></span> 
